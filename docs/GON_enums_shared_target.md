...
| aoe_restrictions | [[aoe restriction]](GON_enums_aoe_restrictions.html) | AOE Restrictions that need to be followed for a tile to be accepted in the aoe |
| restrictions | [[restriction]](GON_enums_restrictions.html) | Restrictions that need to be followed for a tile to be accepted as targettable |
| target_requires_tag | string | (MUST_HAVE_TAG) tag check |
| target_requires_element | [element](GON_enums_elements.html) | (MUST_HAVE_ELEMENT) Element check |
...
| X_is | [X variable](GON_enums_abi_xis.html) | X becomes a chosen variable |
