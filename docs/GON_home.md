...
While objects are generally global, the game will **only** read the files they are put in. Therefore, instead of replacing a .gon file, you can _append_ a .gon file. This means creating a file by the same name as the one you want to add to, and giving ita suffix such as ".patch" as a extension. 
...
## What's the difference between "meta" and "shared"?
