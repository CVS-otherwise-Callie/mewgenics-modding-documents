...
| aoe_restrictions | [[aoe restriction]](https://cvs-otherwise-callie.github.io/mewgenics-modding-documents/gon/enums/aoe_restrictions.html) | AOE Restrictions that need to be followed for a tile to be accepted in the aoe |
| restrictions | [[restriction]](https://cvs-otherwise-callie.github.io/mewgenics-modding-documents/gon/enums/restrictions.html) | Restrictions that need to be followed for a tile to be accepted as targettable |
| target_requires_tag | string | (MUST_HAVE_TAG) tag check |
| target_requires_element | [element](https://cvs-otherwise-callie.github.io/mewgenics-modding-documents/gon/enums/elements.html) | (MUST_HAVE_ELEMENT) Element check |
...
| X_is | [X variable](https://cvs-otherwise-callie.github.io/mewgenics-modding-documents/gon/enums/abi_xis.html) | X becomes a chosen variable |
